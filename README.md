# ماژول مدیریت سبد خرید فروشگاه (Basket Management Microservice)

> فروشگاه انلاین با معماری میکروسرویس **Mansari**

---

# معرفی پروژه

این پروژه پیاده‌سازی ماژول مدیریت سبد خرید (Basket Management) برای سامانه فروشگاهی من است که با استفاده از **.NET 8** و بر پایه اصول معماری نرم‌افزار مدرن توسعه داده شده است.
